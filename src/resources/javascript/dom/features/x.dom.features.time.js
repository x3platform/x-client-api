...
x.dom.features.time = {
    ...
    */
    bind: function(inputName)
    {
        ...
        // 日历
        window[calendarName] = x.calendar.newCalendar(calendarName, calendarName, inputName + '_calendarValue', defaultCalendarValue, {
        ...
        window[timeName] = x.combobox.newCombobox(timeName, timeName, inputName + '_timeValue', inputName + '_timeValue', options);
