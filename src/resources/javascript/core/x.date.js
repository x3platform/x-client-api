...
x.date = {
    ...
    {
        return new x.date.newTime(dateValue);
    },
    ...
    add: function(dateValue, interval, number)
    {
        var time = new x.date.newTime(dateValue);
    ...
    * 日期格式化
    */
    format: function(dateValue, formatValue)
    {
        var time = x.date.create(dateValue);
